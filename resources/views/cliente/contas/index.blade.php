            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-md-flex justify-content-center">
                        <a href="{{ route('conta.cliente.show', ['conta' => $conta->id]) }}" class="btn btn-primary btn-sm me-1"><i class="fa fa-eye"></i></a>

                        <a href="{{ route('conta.cliente.edit', ['conta' => $conta->id]) }}" class="btn btn-warning btn-sm me-1"><i class="fa fa-edit"></i></a>

                        <form id="formExcluir{{ $conta->id }}" action="{{ route('conta.cliente.destroy', ['conta' => $conta->id]) }}" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-danger btn-sm me-1 btnDelete" data-delete-id="{{ $conta->id }}"><i class="fa fa-trash"></i></button>
                        </form>
