    ...
    <div class="card mt-4 mb-4 border-light shadow">
        <div class="card-header d-flex justify-content-between">
            ...
            <span>
                ...
                <a href="{{ route('receita.cliente.edit', ['receita' => $receita->id]) }}" class="btn btn-warning btn-sm">Editar</a>
            </span>
        </div>
        ...
        <div class="card-body">
            ...
            <dl class="row">
                ...
                <dd class="col-sm-9">{{ \Carbon\Carbon::parse($receita->created_at)->tz('America/Sao_Paulo')->format('d/m/Y H:i:s') }}</dd>
