...
<div class="card mt-4 mb-4 border-light shadow">
    <div class="card-header d-flex justify-content-between">
        ...
        <span>
            <a href="{{ route('conta.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-md-flex justify-content-center">
                        <a href="{{ route('conta.show', ['conta' => $conta->id]) }}" class="btn btn-primary btn-sm me-1"><i class="fa fa-eye"></i></a>

                        <a href="{{ route('conta.edit', ['conta' => $conta->id]) }}" class="btn btn-warning btn-sm me-1"><i class="fa fa-edit"></i></a>
