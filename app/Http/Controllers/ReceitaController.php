...
class ReceitaController extends Controller
{
    ...
    public function store(ReceitaRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('receita.show', ['receita' => $receita->id])->with('success', 'Receita cadastrada com sucesso');
        } catch (Exception $e) {
    ...
    public function update(ReceitaRequest $request, Receita $receita)
    {
        ...
        try {
            ...
            // Redirecionar o usuário, enviar a mensagem de sucesso
            return redirect()->route('receita.show', ['receita' => $receita->id])->with('success', 'Receita editada com sucesso');
        } catch (Exception $e) {
    ...
    public function destroy(Receita $receita)
    {
        ...
        // Redirecionar o usuário, enviar a mensagem de sucesso
        return redirect()->route('receita.index')->with('success', 'Receita apagada com sucesso');
    }
}
