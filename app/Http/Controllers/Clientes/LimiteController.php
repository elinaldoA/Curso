...
class LimiteController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cliente.limites.index', ['limites' => $limites]);
    }
    ...
    public function show(Limite $limite)
    {
        ...
        // Carregar a VIEW
        return view('cliente.limites.show', ['limite' => $limite]);
    }
    ...
    {
        // Carregar a VIEW
        return view('cliente.limites.create');
    }
    ...
    {
        // Carregar a VIEW
        return view('cliente.limites.edit', ['limite' => $limite]);
    }
