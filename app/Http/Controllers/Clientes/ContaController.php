...
class ContaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Carregar a VIEW
        return view('cliente.contas.index', [
            'contas' => $contas,
            'nome' => $request->nome,
    ...
    public function create()
    {
        ...
        // Carregar a VIEW
        return view('cliente.contas.create', [
    ...
    public function store(ContaRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('conta.cliente.show', ['conta' => $conta->id])->with('success', 'Conta cadastrada com sucesso');
        } catch (Exception $e) {
    ...
    public function edit(Conta $conta)
    {
        ...
        // Carregar a VIEW
        return view('cliente.contas.edit', [
            'conta' => $conta,
            'categorias' => $categorias,
            'situacoesContas' => $situacoesContas,
        ]);
    ...
    public function update(ContaRequest $request, Conta $conta)
    {
        ...
        try {
            ...
            // Redirecionar o usuário, enviar a mensagem de sucesso
            return redirect()->route('conta.cliente.show', ['conta' => $conta->id])->with('success', 'Conta editada com sucesso');
        } catch (Exception $e) {
    ...
    public function destroy(Conta $conta)
    {
        ...
        // Redirecionar o usuário, enviar a mensagem de sucesso
        return redirect()->route('conta.cliente.index')->with('success', 'Conta apagada com sucesso');
    }
